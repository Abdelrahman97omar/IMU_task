...
echo_and_run cd "/home/abdelrahman/Arduino/imu task/Testing workspace/src/roslint"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/abdelrahman/Arduino/imu task/Testing workspace/src/roslint/setup.py" \
    egg_info --egg-base /home/abdelrahman/Arduino/imu task/Testing workspace/build/roslint \
    build --build-base "/home/abdelrahman/Arduino/imu task/Testing workspace/build/roslint" \
    install \
    --root="${DESTDIR-/}" \
