...
set_target_properties(GeographicLib PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "/home/abdelrahman/Arduino/imu task/Testing workspace/build/GeographicLib-prefix/src/GeographicLib/include;/home/abdelrahman/Arduino/imu task/Testing workspace/build/GeographicLib-prefix/src/GeographicLib/include"
)
...
set_target_properties(GeographicLib PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/abdelrahman/Arduino/imu task/Testing workspace/build/GeographicLib-prefix/src/GeographicLib/src/libGeographic.so.14.0.1"
...
set_target_properties(CartConvert PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/abdelrahman/Arduino/imu task/Testing workspace/build/GeographicLib-prefix/src/GeographicLib/tools/CartConvert"
  )
...
set_target_properties(ConicProj PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/abdelrahman/Arduino/imu task/Testing workspace/build/GeographicLib-prefix/src/GeographicLib/tools/ConicProj"
  )
...
set_target_properties(GeodesicProj PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/abdelrahman/Arduino/imu task/Testing workspace/build/GeographicLib-prefix/src/GeographicLib/tools/GeodesicProj"
  )
...
set_target_properties(GeoConvert PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/abdelrahman/Arduino/imu task/Testing workspace/build/GeographicLib-prefix/src/GeographicLib/tools/GeoConvert"
  )
...
set_target_properties(GeodSolve PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/abdelrahman/Arduino/imu task/Testing workspace/build/GeographicLib-prefix/src/GeographicLib/tools/GeodSolve"
  )
...
set_target_properties(GeoidEval PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/abdelrahman/Arduino/imu task/Testing workspace/build/GeographicLib-prefix/src/GeographicLib/tools/GeoidEval"
  )
...
set_target_properties(Gravity PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/abdelrahman/Arduino/imu task/Testing workspace/build/GeographicLib-prefix/src/GeographicLib/tools/Gravity"
  )
...
set_target_properties(MagneticField PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/abdelrahman/Arduino/imu task/Testing workspace/build/GeographicLib-prefix/src/GeographicLib/tools/MagneticField"
  )
...
set_target_properties(Planimeter PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/abdelrahman/Arduino/imu task/Testing workspace/build/GeographicLib-prefix/src/GeographicLib/tools/Planimeter"
  )
...
set_target_properties(RhumbSolve PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/abdelrahman/Arduino/imu task/Testing workspace/build/GeographicLib-prefix/src/GeographicLib/tools/RhumbSolve"
  )
...
set_target_properties(TransverseMercatorProj PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/abdelrahman/Arduino/imu task/Testing workspace/build/GeographicLib-prefix/src/GeographicLib/tools/TransverseMercatorProj"
  )
