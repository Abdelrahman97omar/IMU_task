...
echo_and_run cd "/home/abdelrahman/Arduino/imu task/Testing workspace/src/geographic_info/geodesy"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/abdelrahman/Arduino/imu task/Testing workspace/src/geographic_info/geodesy/setup.py" \
    egg_info --egg-base /home/abdelrahman/Arduino/imu task/Testing workspace/build/geographic_info/geodesy \
    build --build-base "/home/abdelrahman/Arduino/imu task/Testing workspace/build/geographic_info/geodesy" \
    install \
    --root="${DESTDIR-/}" \
